...
import { NavbarContainer,Container,Col,Logo,NavbarCollapse,NavbarCollapseInner,Ullist,MenuLinkdiv,ToggleButton,MainDiv,SideBar,CloseDiv,
  Menu,Dropdown,DropdownContent,MenuLink,DropdownLink,Searchbar,Btn,Searchbtn,ModalBody,Items,Itemsbox,SideBarLink,IconsDiv,Facebook,Instagram,Linkedin,Pinterest,Twitter,SearchIcon} from "../Navbar/Styles/Navbar.styled";
...
export default function Navbar() {
  ...
  const {data , error} = useSWR('http://localhost:3002/api/web/product/type/get', fetcher)
 ...
 const result = data.data.map((item) => {
  return(
    <>
    <SideBarLink href="/products">{item.name}</SideBarLink><br/>
    </>
  )})
  ...
  return (
    ...
    <NavbarContainer>
     <Container>
      ...
      <MainDiv>
        <SideBar>
          <CloseDiv  onClick={() => setToggle(false)}>
          &#10005;
          </CloseDiv> 
          <IconsDiv>
          <SearchIcon/>
          ...
          <Items>
          <SideBarLink href="/products/products">Products &#43;</SideBarLink>
          ...
          <NavbarCollapseInner>
            <Ullist>
              ...
              <Dropdown>
                ...
                <DropdownContent>
                  <DropdownLink href="/products/hardgel">{result}</DropdownLink>
                </DropdownContent>
              </Dropdown>
              <Dropdown>
                <Menu>
